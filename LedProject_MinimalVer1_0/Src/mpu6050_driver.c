...
/**
  * @brief Bu fonksiyon ivme sensörlerinden elde edilen G kuvvetlerini 
	*				 x ve y açi degerlerine dönüstürerek kullanica sunar
  * @param X ekseni ivme açisini gösteren bir accel_angle_x pointer 
  * @param Y ekseni ivme açisini gösteren bir accel_angle_y pointer 
  * @retval yok 
  */
